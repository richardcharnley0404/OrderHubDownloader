...
stubInCache(path.join(SVC, 'routing-service.js'),                 { migrateFromPrintControllerStore: () => {}, backfillLegacyPrintSizeCode: () => {}, stripDeprecatedConfigJsonKeys: () => {}, getControllers: () => [], resolveRoute: () => null, getRoutingHeldProcesses: () => new Set() });
