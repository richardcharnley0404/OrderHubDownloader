...
stubInCache(path.join(SVC, 'routing-service.js'),                 { migrateFromPrintControllerStore: () => {}, stripDeprecatedConfigJsonKeys: () => {}, getControllers: () => [], resolveRoute: () => null, getRoutingHeldProcesses: () => new Set() });
